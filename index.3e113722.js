...
t=tN(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tP=k.toFlatObject(k,{},null,function(t){return/^is[A-Z]/.test(t)});var t_=/**
...
const{Axios:ew,AxiosError:eA,CanceledError:eO,isCancel:eR,CancelToken:eB,VERSION:ev,all:eS,Cancel:eT,isAxiosError:eU,spread:eC,toFormData:eI,AxiosHeaders:ex,HttpStatusCode:eN,formToJSON:eL,getAdapter:eP,mergeConfig:e_}=eE;eE.defaults.headers.common["x-api-key"]="live_iGSvPnRg8pvnoWaV96pD0qkOsNoyBuZMZKzZwbBPoVdtkf8QV2suGCLls79FwX1C";const ej="https://api.thecatapi.com/v1",eF=document.querySelector(".breed-select"),eD=document.querySelector(".loader"),ek=document.querySelector(".error"),eM=document.querySelector(".cat-info");function e$(t){eM.innerHTML=`
